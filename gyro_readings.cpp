...
int main(){
   ...
   while(count < 60){
      ...
      cout<<"Gyroscope values: ";
      cout << "X="<<gx<<" Y="<<gy<<" Z="<<gz<<" sample="<<count<<endl;
      cout<<"Accelerometer values: ";
      cout << "X="<<ax<<" Y="<<ay<<" Z="<<az<<" sample="<<count<<endl;
      cout<<"Magnetometer values: ";
      cout << "X="<<mx<<" Y="<<my<<" Z="<<mz<<" sample="<<count<<endl;
